        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BookLists_CurrentlyReadingId",
                        column: x => x.CurrentlyReadingId,
                        principalTable: "BookLists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BookLists_ReadId",
                        column: x => x.ReadId,
                        principalTable: "BookLists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_BookLists_WantToReadId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CurrentlyReadingId",
                table: "AspNetUsers",
                column: "CurrentlyReadingId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ReadId",
                table: "AspNetUsers",
                column: "ReadId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_WantToReadId",
                table: "AspNetUsers",
                column: "WantToReadId");
